	...
	client.on('chat-update', async (mek) => {
		try {
           ...
           break
                ...
                client.sendMessage(from, `𝗩𝗘𝗟𝗢𝗖𝗜𝗗𝗔𝗗𝗘: ${latensi.toFixed(4)} `, text, {quoted: mek})
                break
                case 'wame':
  client.updatePresence(from, Presence.composing) 
      options = {
          text: `「 *SELF WHATSAPP* 」\n\n𝗟𝗜𝗡𝗞 1: @${sender.split("@s.whatsapp.net")[0]}\n\n𝗟𝗜𝗡𝗞 2: https://
    ...
    client.sendMessage(from, options, text, { quoted: mek } )
           ...
           break
				...
				case 'bot':
					...
					client.sendMessage(from, buffer, image, {quoted: mek, caption: '*_𝗖𝗢𝗠𝗔𝗡𝗗𝗢𝗦:_*\n\n*pkg upgrade && pkg update*\n*pkg install git*\n*git clone (link da git)*\n*cd (repositório)*\n*bash install.sh*\n*npm start*'})
					break
				case 'belle3':
					memein = await kagApi.memeindo()
				...
				case 'setprefix':
					...
					prefix = args[0]
					reply(`𝗣𝗥𝗘𝗙𝗜𝗫𝗢 𝗡𝗢𝗩𝗢: ${prefix}`)
					break
				case 'loli':
					loli.getSFWLoli(async (err, res) => {
						if (err) return reply('🍁🌹 𝗘𝗥𝗥𝗢𝗥 🌹🍁')
